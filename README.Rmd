...
The goal of PIPScreening is to determine the active variables in the discrepancy function when calibrating a computer model.
This relies on the Kennedy and O'Hagan (2001) framework for Bayesian calibration of computer model.
