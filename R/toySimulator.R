...
#'
#' @param x Matrix of field design in dimension n \eqn{\times} p (with p>3). Only the 3 first rows of x are
#' taken into account
...
#' @param theta Calibration parameter of dimension 3
#' @param beta binary vector. Same size as \code{theta} indicating with 1 which dimensions are active
#'
